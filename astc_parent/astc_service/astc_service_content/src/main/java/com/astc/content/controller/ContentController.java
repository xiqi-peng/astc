package com.astc.content.controller;

import com.astc.content.pojo.Content;
import com.astc.content.service.ContentService;
...
public class ContentController {
    ...
    public Result findContentsByCategoryId(@PathVariable(value = "categoryId") Long categoryId) {
        List<Content> list = contentService.findContentsByCategoryId(categoryId);
