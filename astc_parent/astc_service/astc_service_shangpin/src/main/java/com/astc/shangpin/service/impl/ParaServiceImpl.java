...
import com.astc.shangpin.dao.ParaMapper;
...
public class ParaServiceImpl implements ParaService {
     ...
     */
    @Override
    public List<Para> findParaListBycategoryId(Integer categoryId) {
        Integer templateId = categoryMapper.selectByPrimaryKey(categoryId).getTemplateId();
        Para para = new Para();
