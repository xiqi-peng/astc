...
import com.astc.shangpin.pojo.Template;
import com.astc.shangpin.service.TemplateService;
...
public class TemplateController {
    ...
    public Result findTempBycategoryId(@PathVariable(value = "categoryId") Integer categoryId) {
        Template template = templateService.findTempBycategoryId(categoryId);
        return new Result(true, StatusCode.OK, "查询商品模板成功", template);
    }
