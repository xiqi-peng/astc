...
import com.astc.shangpin.pojo.Category;
import com.astc.shangpin.service.CategoryService;
...
public class CategoryController {
    ...
    public Result<List<Category>> findCategoryListByParentId(@PathVariable(value = "parentId") Integer parentId) {
        List<Category> list = categoryService.findCategoryListByParentId(parentId);
        return new Result<>(true, StatusCode.OK, "查询商品分类成功", list);
    }
