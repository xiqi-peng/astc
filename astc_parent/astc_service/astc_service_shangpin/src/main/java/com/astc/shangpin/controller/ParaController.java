package com.astc.shangpin.controller;

import com.astc.shangpin.pojo.Para;
import com.astc.shangpin.service.ParaService;
...
public class ParaController {
    ...
    @GetMapping("/findParaListBycategoryId/{categoryId}")
    public Result findSpecByCategoryId(@PathVariable(value = "categoryId") Integer categoryId) {
        List<Para> paras = paraService.findParaListBycategoryId(categoryId);
        return new Result(true, StatusCode.OK, "规格查询成功", paras);
    }
    /***
     * Para分页条件搜索实现
     * @param para
