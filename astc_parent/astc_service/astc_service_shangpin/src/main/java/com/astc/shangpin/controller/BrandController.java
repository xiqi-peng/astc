...
import com.astc.shangpin.service.BrandService;
...
public class BrandController {
    ...
    public Result findBrandsByCategoryId(@PathVariable(value = "categoryId") Integer categoryId) {
        List<Brand> list = brandService.findBrandsByCategoryId(categoryId);
        return new Result(true, StatusCode.OK, "加载商品品牌列表成功", list);
    }
