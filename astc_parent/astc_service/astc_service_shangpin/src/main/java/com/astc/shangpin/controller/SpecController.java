...
import com.astc.shangpin.pojo.Spec;
import com.astc.shangpin.service.SpecService;
...
public class SpecController {
    ...
    @GetMapping("/findSpecistBycategoryId/{categoryId}")
    public Result findSpecByCategoryId(@PathVariable(value = "categoryId") Integer categoryId) {
        List<Spec> specs = specService.findSpecByCategoryId(categoryId);
